...
3 Create a new user to be used as "Web Services User", assign a role with enough privileges (manager or admin). Ensure that the role has the capabilities. webservice/soap:use or webservice/rest:use or webservice/xmlrpc:use
...
6 Administration / Plugins / Web Services / Manage tokens. Create a token for the user created in step 3 for the service "Extra Services"
