...
class mod_forum_get_forum_discussion_posts_test extends externallib_advanced_testcase {
    ...
    public function test_mod_forum_get_forum_discussion_posts() {
        ...
        $posts = \local_aspiredu\external\mod_forum_get_forum_discussion_posts::execute($discussion1->id, 'modified', 'DESC');
        $posts = external_api::clean_returnvalue(\local_aspiredu\external\mod_forum_get_forum_discussion_posts::execute_returns(), $posts);
        ...
        $posts = \local_aspiredu\external\mod_forum_get_forum_discussion_posts::execute($discussion2->id, 'modified', 'DESC');
        $posts = external_api::clean_returnvalue(\local_aspiredu\external\mod_forum_get_forum_discussion_posts::execute_returns(), $posts);
        ...
        $posts = \local_aspiredu\external\mod_forum_get_forum_discussion_posts::execute($discussion3->id, 'modified', 'DESC');
        $posts = external_api::clean_returnvalue(\local_aspiredu\external\mod_forum_get_forum_discussion_posts::execute_returns(), $posts);
        foreach ($posts['posts'] as $post) {
    ...
    public function test_mod_forum_get_forum_discussion_posts_deleted() {
        ...
        $posts = \local_aspiredu\external\mod_forum_get_forum_discussion_posts::execute($discussion->id, 'modified', 'DESC');
        $posts = external_api::clean_returnvalue(\local_aspiredu\external\mod_forum_get_forum_discussion_posts::execute_returns(), $posts);
